...
class FlickrConstants: NSObject {
  ...
  static let FLICKR_SECRET:String = "yourFlickrSecret"
  ...
  static let SMALL_IMAGE_SIZE:FlickrPhoto.FlickrPhotoSize = FlickrPhoto.FlickrPhotoSize.PhotoSizeSmallSquare75
  static let BIG_IMAGE_SIZE:FlickrPhoto.FlickrPhotoSize = FlickrPhoto.FlickrPhotoSize.PhotoSizeLarge1024
